...
// La clase Murcielago_Volcan implementa la interfaz Murcielago y representa un tipo de enemigo
public class Murcielago_Volcan implements Murcielago {
    ...
    public Murcielago_Volcan(Murcielago_Estrategia estrategia) {
        this.estrategia = estrategia;
        this.nombre = "Murcielago del Volcan";
        this.vida = 20;
        this.danio = 10;
        this.magia = 0;
        this.velocidad = 3;
    ...
    @Override
    public int getVida() {
        // Multiplica la vida del murciélago por la dificultad del mundo VOLCAN
        return vida * Mundos.VOLCAN.getDificultad();
    }

    @Override
    public int getDanio() {
        // Multiplica el daño del murciélago por la dificultad del mundo VOLCAN
        return danio * Mundos.VOLCAN.getDificultad();
    }

    @Override
    public int getMagia() {
        // Multiplica la magia del murciélago por la dificultad del mundo VOLCAN
        return magia * Mundos.VOLCAN.getDificultad();
    }

    @Override
    public int getVelocidad() {
        // Multiplica la velocidad del murciélago por la dificultad del mundo VOLCAN
        return velocidad * Mundos.VOLCAN.getDificultad();
    }

    @Override
    public EstadoJugador estadoAplicable() {
        // Devuelve el estado quemado aplicable al murciélago del volcán
